// src/components/BirdsAccessoryDetails.js
...
const BirdsAccessoriesProductDetails = () => {
  const { id } = useParams();
  ...
  useEffect(() => {
    fetch(`http://localhost:5001/api/v1/birdsaccessories/${id}`)
      .then((response) => {
        if (!response.ok) {
...
export default BirdsAccessoriesProductDetails;
