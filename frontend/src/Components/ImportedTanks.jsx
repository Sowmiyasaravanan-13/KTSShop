...
const ImportedTanks = () => {
  ...
  useEffect(() => {
    fetch('http://localhost:5001/api/v1/importedtanks')
      .then(response => {
        if (!response.ok) {
  ...
  return (
    <div className="container mx-auto mt-8">
      <h1 className="text-2xl font-bold mb-4">Imported Tanks</h1>
