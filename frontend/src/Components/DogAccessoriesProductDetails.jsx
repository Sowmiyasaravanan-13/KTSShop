// src/components/DogAccessoryDetails.js
...
const DogAccessoriesProductDetails = () => {
  const { id } = useParams();
  ...
  useEffect(() => {
    fetch(`http://localhost:5001/api/v1/dogaccessories/${id}`)
      .then((response) => {
        if (!response.ok) {
...
export default DogAccessoriesProductDetails;
